...
<?php include 'header.php'; ?>
    ...
    <a href="photobox.php?theme=photobox" class="theme-option <?php echo $selectedTheme == 'photobox' ? 'active' : ''; ?>">PhotoBox</a>
        ...
        <div class="theme-card">
            <img src="img/bestie.jpg" alt="Tema 1">
            <div class="theme-card-content">
                <h3>Baby Pink</h3>
                <p>Potretkan kebahagiaanmu, karena kenangan adalah investasi terbaik.</p>
                <a href="booking.php?theme=me_time" class="booking-button">Booking Sekarang</a>
            </div>
        </div>
        <div class="theme-card">
            <img src="img/pink1.jpg" alt="Tema 2">
            <div class="theme-card-content">
                <h3>Baby Pink</h3>
                <p>Foto terbaik bukan hanya tentang pencahayaan, tapi tentang perasaan.</p>
                <a href="booking.php?theme=bestie" class="booking-button">Booking Sekarang</a>
            </div>
        </div>
        <div class="theme-card">
            <img src="img/pink.jpg" alt="Tema 2">
            <div class="theme-card-content">
                <h3>Baby Pink</h3>
                <p>Dunia bisa berubah, tapi foto yang indah akan bertahan selamanya.</p>
                <a href="booking.php?theme=bestie" class="booking-button">Booking Sekarang</a>
            </div>
        </div>

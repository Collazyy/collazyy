...
<?php include 'header.php'; ?>
    ...
    <a href="photobox.php?theme=photobox" class="theme-option <?php echo $selectedTheme == 'photobox' ? 'active' : ''; ?>">PhotoBox</a>
        ...
        <div class="theme-card">
            <img src="img/Ocean Green.jpg" alt="Tema 1">
            <div class="theme-card-content">
                <h3>Ocean Green</h3>
                <p>Karena setiap gambar punya cerita, biarkan kami menangkapnya untukmu.</p>
                <a href="booking.php?theme=me_time" class="booking-button">Booking Sekarang</a>
            </div>
        </div>
        <div class="theme-card">
            <img src="img/ocean.jpg" alt="Tema 2">
            <div class="theme-card-content">
                <h3>Ocean Green</h3>
                <p>Jepretan hari ini adalah kenangan berharga di masa depan.</p>

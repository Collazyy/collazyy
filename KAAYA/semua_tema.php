...
<?php include 'header.php'; ?>
    ...
    <a href="photobox.php?theme=photobox" class="theme-option <?php echo $selectedTheme == 'photobox' ? 'active' : ''; ?>">PhotoBox</a>
        ...
        <div class="theme-card">
            <img src="img/White.jpg" alt="Tema 1">
        ...
        <div class="theme-card">
            <img src="img/Ocean Green.jpg" alt="Tema 2">
            <div class="theme-card-content">
                <h3>OCEAN GREEN</h3>
        ...
        <div class="theme-card">
            ...
            <div class="theme-card-content">
                <h3>BABY PINK</h3>
                <p>Setiap momen berharga layak diabadikan dengan indah.</p>
                <a href="booking.php?theme=bestie" class="booking-button">Booking Sekarang</a>
            </div>
        </div>
        <div class="theme-card">
            ...
            <div class="theme-card-content">
                <h3>BROWN</h3>
                <p>Potretkan momen terbaikmu, karena kenangan tak ternilai harganya.</p>
                <a href="booking.php?theme=bestie" class="booking-button">Booking Sekarang</a>
            </div>
        </div>
        <div class="theme-card">
            <img src="img/Brown.jpg" alt="Tema 2">
            <div class="theme-card-content">
                <h3>GREY</h3>
                <p>Ciptakan kisah yang tak terlupakan dalam satu frame penuh makna.</p>
                <a href="booking.php?theme=bestie" class="booking-button">Booking Sekarang</a>
            </div>
        </div>
        <div class="theme-card">
            <img src="img/Little Blue.jpg" alt="Tema 2">
            <div class="theme-card-content">
                <h3>LITTLE BLUE</h3>
                <p>Kebersamaan lebih indah saat diabadikan dengan penuh cinta.</p>
                <a href="booking.php?theme=bestie" class="booking-button">Booking Sekarang</a>
            </div>
        </div>
        <div class="theme-card">
            <img src="img/me time.jpg" alt="Tema 2">
            <div class="theme-card-content">
                <h3>Background 2</h3>
                <p>Satu foto, sejuta cerita. Mari abadikan momen spesialmu!.</p>
                <a href="booking.php?theme=bestie" class="booking-button">Booking Sekarang</a>
            </div>
        </div>
        <div class="theme-card">
            ...
            <div class="theme-card-content">
                <h3>Photobox</h3>
                <p>Karena setiap detik berharga, abadikan dengan sempurna.</p>
                <a href="booking.php?theme=bestie" class="booking-button">Booking Sekarang</a>
            </div>
        </div>

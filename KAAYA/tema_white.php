...
<?php include 'header.php'; ?>
    ...
    <a href="photobox.php?theme=photobox" class="theme-option <?php echo $selectedTheme == 'photobox' ? 'active' : ''; ?>">PhotoBox</a>
        ...
        <div class="theme-card">
            <img src="img/white1.jpg" alt="Tema 1">
            <div class="theme-card-content">
                <h3>White</h3>
                <p>Setiap potret adalah kisah yang menunggu untuk diceritakan.</p>
                <a href="booking.php?theme=me_time" class="booking-button">Booking Sekarang</a>
            </div>
        </div>
        <div class="theme-card">
            <img src="img/white2.jpg" alt="Tema 2">
            <div class="theme-card-content">
                <h3>White</h3>
                <p>Abadikan setiap detik berharga, karena waktu tak akan terulang.</p>
                <a href="booking.php?theme=bestie" class="booking-button">Booking Sekarang</a>
            </div>
        </div>
        <div class="theme-card">
            <img src="img/white3.jpg" alt="Tema 2">
            <div class="theme-card-content">
                <h3>White</h3>
                <p>Bersiaplah untuk mengabadikan senyum terbaikmu!</p>
                <a href="booking.php?theme=bestie" class="booking-button">Booking Sekarang</a>
            </div>
        </div>
